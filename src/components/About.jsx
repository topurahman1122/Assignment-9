        ...
        <div className='flex flex-col w-full divide-y sm:flex-row sm:divide-y-0 sm:divide-x sm:px-8 lg:px-12 xl:px-32 divide-gray-700'>
          <div className='flex flex-col w-full divide-y divide-gray-700'>
            ...
            >
              ...
              Answer 1-nawerReact Router is a standard library for routing in React. It enables the navigation among views of various components in a React Application, allows changing the browser URL, and keeps the UI in sync with the URL.
            ...
            >
              ...
              Answer 2-The React Context API is a way for a React app to effectively produce global variables that can be passed around. This is the alternative to "prop drilling" or moving props from grandparent to child to parent, and so on. Context is also touted as an easier, lighter approach to state management using Redux.
            </Link>
            <Link
              to='/support'
              className='flex items-center justify-center p-4 sm:py-8 lg:py-12'
            >
              ...
              Answer 3-Refs are a function provided by React to access the DOM element and the React element that you might have created on your own. They are used in cases where we want to change the value of a child component, without making use of props and all.
            </Link>
          </div>
          <div className='flex flex-col w-full divide-y divide-gray-700'>
